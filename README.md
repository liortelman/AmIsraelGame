...
- [x] Add **Undo / Back** option (admin safety):
  - [x] Undo last scoring action (points + restore used question)
  - [x] Undo duel winner selection
  - [x] Undo “No points” (restore question)
