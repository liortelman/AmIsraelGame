    ...
    "figures": {
      ...
      "questions": [
        ...
        { "id": "figures-6", "points": 10, "type": "for_everyone",
          ...
          "options": ["סופר עברי, חתן פרס נובל לספרות - שמואל יצחק", "זמר ישראלי, מפיק שירים לארוויזיון - שי יגנס", "רופא בכיר באיכילוב וחוקר - שלמה יהוד", "שחקן ילדים מוכר, השתתף בפסטיגל - שילה יגל"],
