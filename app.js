    ...
    "places": {
      ...
      "questions": [
        ...
        { "id": "places-7", "points": 20, "type": "duel",
          ...
          "question": "זהו את התמונות הבאות (כל תשובה נכונה = 4 נק׳)",
          "options": [],
    ...
    "figures": {
      ...
      "questions": [
        ...
        { "id": "figures-6", "points": 10, "type": "for_everyone",
          ...
          "options": ["סופר עברי, חתן פרס נובל לספרות - שמואל יצחק", "זמר ישראלי, מפיק שירים לארוויזיון - שי יגנס", "הרמטכל במלחמת יום כיפור - שאול ישעיהו", "שחקן ילדים מוכר, השתתף בפסטיגל - שילה יגל"],
          "answer": "סופר עברי, חתן פרס נובל לספרות - שמואל יצחק",
          "hint": "" },
